...
class WeatherModel {
  ...
  Color getAirQualityAmbience(int? condition) {
    ...
    if (condition <= 50) {
      return Color.fromARGB(255, 5, 210, 26);
    } else if (condition >= 51 && condition <= 100) {
      return Color.fromARGB(255, 224, 217, 15);
    } else if (condition >= 101 && condition <= 150) {
      return Color.fromARGB(255, 243, 180, 8);
    } else if (condition >= 151 && condition <= 200) {
      return Color.fromARGB(255, 227, 18, 18);
    } else if (condition == 801) {
      return const Color(0xFFFAE636);
    } else if (condition <= 804) {
      return const Color(0xFFFFFBDC);
    } else {
      return const Color(0xFFFAE636);
    }
  }
